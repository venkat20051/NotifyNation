...
import '../navy.css' // Make sure to create this CSS file
...
function Bank() {
  ...
  const filterdata = bankData.filter((data) => {
  ...
  const final_data = searched ? filterdata : bankData;

  return(
    <div>
      
      <div className='search1'>
        <div className=" venkatpani"><h3>Bank Examination </h3></div>
       <div>
