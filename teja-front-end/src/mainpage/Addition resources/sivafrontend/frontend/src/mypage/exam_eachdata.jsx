export const Eachexam_Structure = {
    ssc:{
   "1. SSC CGL (Combined Graduate Level) Exam Structure": {
     "Tire1": {                                              
     ...
     "Tire2": {
       ...
       TotalPapers: " 2–4 (depending on the post)",
   ...
   "2.SSC CHSL (Combined Higher Secondary Level) Exam Structure": {
     "Tire1": {
 ...
 "3.SSC MTS (Multi-Tasking Staff) Exam Structure":{
 ...
 "4.SSC JE (Junior Engineer) Exam Structure":{
   "Tire1": {
       Subjects: "General Intelligence & Reasoning, General Awareness, Numerical Aptitude, General English.",
       TotalQuestions: "100",
       TotalMarks: "100",
 ...
 "5. SSC General Duty (GD) Constable Exam":{
   "Tire1": {
 ...
 navy: {
     "1.SSR (Senior Secondary Recruit)":{
   ...
   "Tire3": {
    ...
    "3. AA (Artificer Apprentice)":{
     ...
     "4. Indian Coast Guard (Navik GD and DB)":{
       "Tire1": {
         Duration: "60 min",
    ...
    army:{
     "1.Army Soldier General Duty (GD) Exam": {
     "1. Tier 1": {
   ...
   "3.Army Soldier Clerk/Store Keeper Technical Exam": {
     "1. Tier 1": {
   ...
   "4.Army Soldier Nursing Assistant Exam": {
     "1. Tier 1": {
   ...
   airforce:{
     "1. Air Force X Group Exam Structure": {
     "1. Tier 1": {
   ...
   "2. Air Force Y Group Exam Structure": {
     "1. Tier 1": {
   ...
   "3. Air Force NCC Special Entry Exam Structure": {
     "1. Tier 1": {
   ...
   "4. Air Force Ground Duty (Non-Technical) Exam Structure": {
     "1. Tier 1": {
   ...
   "5. Air Force Technical Entry Scheme (TES) Exam Structure": {
     "1. Tier 1": {
 ...
 railway:{
   ...
   "5. RRB Ministerial and Isolated Categories": {
     "1. Tier 1": {
       Subjects: "General Awareness, Mathematics, General Intelligence and Reasoning.",
       TotalQuestions: "100",
       TotalMarks: "100",
